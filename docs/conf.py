...
try:
    from dppd_plotnine import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'dppd_plotnine-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'dppd_plotnine Documentation',
